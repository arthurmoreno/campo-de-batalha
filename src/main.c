...
void jogador_load(int posicao2, SDL_Rect offset2, SDL_Surface *jogador2, SDL_Rect jogador2_c[], SDL_Surface *screen)
{
    switch (posicao2)
	{
		case 0:
...
void pontuacao_load(int pontuacao3, SDL_Rect pontuacao03, SDL_Surface *pontuacao, SDL_Rect pontuacao01[], SDL_Surface *screen)
{
    switch (pontuacao3)
    {
        case 0: SDL_BlitSurface(pontuacao,&pontuacao01[0],screen,&pontuacao03);
                break;
  case 1: SDL_BlitSurface(pontuacao,&pontuacao01[1],screen,&pontuacao03);
                break;
  case 2: SDL_BlitSurface(pontuacao,&pontuacao01[2],screen,&pontuacao03);
                break;
  case 3: SDL_BlitSurface(pontuacao,&pontuacao01[3],screen,&pontuacao03);
                break;
  case 4: SDL_BlitSurface(pontuacao,&pontuacao01[4],screen,&pontuacao03);
                break;
  case 5: SDL_BlitSurface(pontuacao,&pontuacao01[5],screen,&pontuacao03);
                break;
  case 6: SDL_BlitSurface(pontuacao,&pontuacao01[6],screen,&pontuacao03);
                break;
    }
}
...
int main( int argc, char* args[] )
{
	...
	int quit1, quit2, x, entrar, bala1, bala2, pontuacao1, pontuacao2, vencedor0; //variaveis de controle e de pontuacao e numeracao
	...
	{
		screen = SDL_SetVideoMode(640,480,32,SDL_SWSURFACE);//atribui��o de uma superficie de video 640 x 480 para a variavel screen
		...
		if (entrar == 1)//condi��o 1 (para tela inicial)
		{
            ...
            SDL_SetColorKey(jogador1, SDL_SRCCOLORKEY|SDL_RLEACCEL,(Uint16)SDL_MapRGB(jogador1->format, 0,255,0));//para por transparencia no verde.
            jogador2 = SDL_LoadBMP("resources/jogador2.bmp");
            SDL_SetColorKey(jogador2, SDL_SRCCOLORKEY|SDL_RLEACCEL,(Uint16)SDL_MapRGB(jogador2->format, 0,255,0));//para por transparencia no verde.
            bala = SDL_LoadBMP("resources/bala.bmp");
            SDL_SetColorKey(bala, SDL_SRCCOLORKEY|SDL_RLEACCEL,(Uint16)SDL_MapRGB(bala->format, 0,255,0));//para por transparencia no verde.
            explosao = SDL_LoadBMP("resources/explosao.bmp");
            SDL_SetColorKey(explosao, SDL_SRCCOLORKEY|SDL_RLEACCEL,(Uint16)SDL_MapRGB(explosao->format, 0,255,0));//para por transparencia no verde.
            pontuacao = SDL_LoadBMP ("resources/numeros.bmp");
            SDL_SetColorKey(pontuacao, SDL_SRCCOLORKEY|SDL_RLEACCEL,(Uint16)SDL_MapRGB(pontuacao->format, 0,255,0));//para por transparencia no verde.
        ...
        {
            SDL_FreeSurface( telaprincipal );
            telaprincipal = SDL_LoadBMP ("resources/menuonline.bmp");// troca a imagem bmp para o menu para online
            SDL_BlitSurface(telaprincipal,NULL,screen,NULL);
            SDL_Flip (screen);
        ...
        if (entrar == 5)//condi��o de entrada para o servidor(quem criou o jogo)
        {
            ...
            SDL_FreeSurface( telaprincipal );
            telaprincipal = SDL_LoadBMP ("resources/mododeespera.bmp");// troca a imagem bmp para o menu para online
            SDL_BlitSurface(telaprincipal,NULL,screen,NULL);
            SDL_Flip (screen);
            ...
            if(bind(sServer, (LPSOCKADDR)&sinServer, sizeof(sinServer)) == SOCKET_ERROR)
            {
                ...
                MessageBox(NULL, (LPCTSTR)"Could not bind the server!()", (LPCTSTR)"Campo de batalha", MB_OK|MB_ICONERROR);
                WSACleanup();
                return 0;
            }
            ...
            MessageBox(NULL, (LPCTSTR)"Esperando por clientes", (LPCTSTR)"Campo de batalha", MB_OK);
            ...
            {
                MessageBox(NULL, (LPCTSTR)"Nao eh possivel aceitar esse cliente!", (LPCTSTR)"Campo de batalha", MB_OK);
                closesocket(sServer);
                WSACleanup();
                return 0;
            }
                    ...
                    if (event.type == SDL_KEYDOWN)// evento do tipo tecla pressionada
                    {
                        switch (event.key.keysym.sym)
                        {
                            case SDLK_1:
                                ...
                                MessageBox(NULL, (LPCTSTR)"dados enviados com sucesso!", (LPCTSTR)"Campo de batalha", MB_OK);
                                break;
                            case SDLK_2:
                                quit = 0;
                                break;
		...
		{
            SDL_FreeSurface( telaprincipal );
            telaprincipal = SDL_LoadBMP ("resources/mododeespera.bmp");// troca a imagem bmp para o menu
            SDL_BlitSurface(telaprincipal,NULL,screen,NULL);
            SDL_Flip (screen);
            ...
            MessageBox(NULL, (LPCTSTR)"digite o ip para se conectar!", (LPCTSTR)"Campo de batalha", MB_OK);
            scanf("%s",cIP);
            ...
            {
                /* failed at starting server */
                MessageBox(NULL, (LPCTSTR)"nao foi possivel conectar-se a um servidor!", (LPCTSTR)"Campo de batalha", MB_OK);
                WSACleanup();
                entrar = 4;
            }
            ...
            MessageBox(NULL, (LPCTSTR)"voce esta conectado ao servidor!", (LPCTSTR)"Campo de batalha", MB_OK);
		...
		if (entrar == 2)//condicao 2 (o jogo em si)
        {
            ...
            pontuacao01[0].x = 0, pontuacao01[0].y = 3, pontuacao01[0].w = 25, pontuacao01[0].h = 35;
            pontuacao01[1].x = 50, pontuacao01[1].y = 3, pontuacao01[1].w = 25, pontuacao01[1].h = 35;
            pontuacao01[2].x = 98, pontuacao01[2].y = 3, pontuacao01[2].w = 25, pontuacao01[2].h = 35;
            pontuacao01[3].x = 147, pontuacao01[3].y = 3, pontuacao01[3].w = 25, pontuacao01[3].h = 35;
            pontuacao01[4].x = 195, pontuacao01[4].y = 3, pontuacao01[4].w = 25, pontuacao01[4].h = 35;
            pontuacao01[5].x = 245, pontuacao01[5].y = 3, pontuacao01[5].w = 25, pontuacao01[5].h = 35;
            pontuacao01[6].x = 294, pontuacao01[6].y = 3, pontuacao01[6].w = 25, pontuacao01[6].h = 35;

            jogador1_c[0].x = 0, jogador1_c[0].y = 0, jogador1_c[0].w = 32, jogador1_c[0].h = 32; // jogador1 virado para direita
            jogador1_c[1].x = 34, jogador1_c[1].y = 34, jogador1_c[1].w = 32, jogador1_c[1].h = 32; // jogador1 virado para cima
            jogador1_c[2].x = 34, jogador1_c[2].y = 0, jogador1_c[2].w = 32, jogador1_c[2].h = 32; // jogador1 virado para baixo
            jogador1_c[3].x = 0, jogador1_c[3].y = 34, jogador1_c[3].w = 32, jogador1_c[3].h = 32; // jogador1 virado para esquerda

            jogador2_c[0].x = 0, jogador2_c[0].y = 0, jogador2_c[0].w = 32, jogador2_c[0].h = 32; // jogador2 virado para direita
            jogador2_c[1].x = 34, jogador2_c[1].y = 34, jogador2_c[1].w = 32, jogador2_c[1].h = 32; // jogador2 virado para cima
            jogador2_c[2].x = 34, jogador2_c[2].y = 0, jogador2_c[2].w = 32, jogador2_c[2].h = 32; // jogador2 virado para baixo
            jogador2_c[3].x = 0, jogador2_c[3].y = 34, jogador2_c[3].w = 32, jogador2_c[3].h = 32; // jogador2 virado para esquerda
                                    ...
                                    switch (posicao1)
                                    {
                                        case 0:
                                            ...
                                            for(bala1 = 1; bala1 < 10; bala1 = bala1 + 1)
                                            {
                                                ...
                                                SDL_Flip(screen);
                                                SDL_Delay(50);
                                                andar(event, screen, telaprincipal, jogador1, jogador2, bala, explosao, pontuacao, pontuacao01, jogador1_c, jogador2_c, wall, menu, offset3, pontuacao02, pontuacao03, bala01, vencedor, quit1, quit2, x, entrar, bala1, bala2,pontuacao1 ,pontuacao2, vencedor0);
                                                if (!colisao (offset2.x,offset2.y,offset2.w,offset2.h,offset3.x,offset3.y,offset3.w,offset3.h))
                                                {
                                                    pontuacao1 = pontuacao1 + 1;
                                                    pontuacao_load(pontuacao1, pontuacao02, pontuacao, pontuacao01, screen);
                                                    SDL_BlitSurface(explosao,NULL,screen,&offset2);
                                    ...
                                    switch (posicao2)
                                    {
                                        case 0:
                                            ...
                                            for(bala1 = 1; bala1 < 10; bala1 = bala1 + 1)
                                            {
                                                ...
                                                SDL_Delay(50);
                                                andar(event, screen, telaprincipal, jogador1, jogador2, bala, explosao, pontuacao, pontuacao01, jogador1_c, jogador2_c, wall, menu, offset3, pontuacao02, pontuacao03, bala01, vencedor, quit1, quit2, x, entrar, bala1, bala2,pontuacao1 ,pontuacao2, vencedor0);
                                                if (!colisao (offset.x,offset.y,offset.w,offset.h,offset3.x,offset3.y,offset3.w,offset3.h))
                                                {
                                                    pontuacao2 = pontuacao2 + 1;
                                                    pontuacao_load(pontuacao2, pontuacao03, pontuacao, pontuacao01, screen);
                                                    SDL_BlitSurface(explosao,NULL,screen,&offset);
